...
class OrderModel extends BaseModel
{
    ...
    function getOrdersClient($filters=array(),$paginator=array(),$order_state){
        ...
        $query = 'SELECT *, o.id as order_id FROM orders o JOIN clients c ON o.client_id = c.id '.( empty($filters) ?  '' : ' WHERE '.$conditions ).' ORDER BY o.'.$order_state.' DESC, o.delivery_date DESC, o.state_prepare DESC LIMIT '.$paginator['limit'].' OFFSET '.$paginator['offset'];
